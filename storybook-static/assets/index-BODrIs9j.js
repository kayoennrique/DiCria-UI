import{j as t}from"./jsx-runtime-DEdD30eg.js";import{d as a}from"./styled-components.browser.esm-DDAiM4bh.js";import{T as o}from"./index-BtBhN9iG.js";const m=a.table`
  width: 100%;
...
`,f=({data:e,columns:i,bgzebracolor:s,bordercollapse:l,bgcolor:d,paddingrows:c,fontsizecolumn:g,fontsizerow:p,className:$,...u})=>t.jsxs(m,{$bgzebracolor:s,$bordercollapse:l,$bgcolor:d,$paddingrows:c,className:`internal-table ${$||""}`,...u,children:[t.jsx("thead",{children:t.jsx("tr",{children:i.map(r=>t.jsx(h,{$bgcolorcolumn:r==null?void 0:r.bgcolumncolor,$textcolorcolumn:r==null?void 0:r.textcolumncolor,$widthpercentage:r==null?void 0:r.widthpercentage,$aligncolumn:r==null?void 0:r.aligncolumn,$fontsizecolumn:g,children:t.jsx(o,{as:"span",children:r.header})},r.key))})}),t.jsx("tbody",{children:e.map((r,b)=>t.jsx("tr",{children:i.map((n,y)=>t.jsx(w,{$alignrow:n==null?void 0:n.alignrow,$fontsizerow:p,children:t.jsx(o,{as:"span",children:r[n.key]})},y))},b))})]});f.__docgenInfo={description:"",methods:[],displayName:"Table",props:{data:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{\r
  [key: string]: React.ReactNode;\r
}`,signature:{properties:[{key:{name:"string"},value:{name:"ReactReactNode",raw:"React.ReactNode",required:!0}}]}}],raw:`{\r
  [key: string]: React.ReactNode;\r
}[]`},description:""},columns:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{\r
  key: string;\r
  header: React.ReactNode;\r
  bgcolumncolor?: string;\r
  textcolumncolor?: string;\r
  widthpercentage?: string;\r
  aligncolumn?: string;\r
  alignrow?: string;\r
}`,signature:{properties:[{key:"key",value:{name:"string",required:!0}},{key:"header",value:{name:"ReactReactNode",raw:"React.ReactNode",required:!0}},{key:"bgcolumncolor",value:{name:"string",required:!1}},{key:"textcolumncolor",value:{name:"string",required:!1}},{key:"widthpercentage",value:{name:"string",required:!1}},{key:"aligncolumn",value:{name:"string",required:!1}},{key:"alignrow",value:{name:"string",required:!1}}]}}],raw:`{\r
  key: string;\r
  header: React.ReactNode;\r
  bgcolumncolor?: string;\r
  textcolumncolor?: string;\r
